				...
				<div class="span9">
					...
					<div class="tab-content">
							...
							<div class="row">
								...
								<div class="span4">
									...
									<p>Nowadays the lingerie industry is one of the most
										...
										popular..</p>
									<a class="btn btn-small pull-right" href="product_details.jsp">View
								...
								<div class="span3 alignR">
									<form class="form-horizontal qtyFrm">
										...
										</label><br /> <a href="product_details.jsp"
						...
						<div class="tab-pane  active" id="blockView">
							<ul class="thumbnails">
								<%
									List<Upload> uploads = (List<Upload>) request
											.getAttribute("uploads");
									if (uploads.size() == 0) {
								%>
								...
								<li class="span3">
									<div class="thumbnail">
										...
										%>
										<a href="product_details.jsp?det=<%=upload.getKeyString()%>"><img
										...
										<div class="caption">
											...
											<h4 style="text-align: center">
												<a class="btn" href="product_details.jsp?det=<%=upload.getKeyString()%>"> <i
													class="icon-zoom-in"></i></a> <a class="btn" href="#">Add
													to <i class="icon-shopping-cart"></i>
												</a> <a class="btn btn-primary" href="#">&euro;<%=upload.getprix()%></a>
											</h4>
										</div>
										<%
					...
					<a href="compair.jsp" class="btn btn-large pull-right">Compair
						Product</a>
